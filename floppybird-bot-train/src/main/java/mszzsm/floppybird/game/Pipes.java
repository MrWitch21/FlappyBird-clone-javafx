...
public class Pipes implements GameObject {
    ...
    private final Asset assetUp = new Asset("up_pipe.png", WIDTH, HEIGHT);
    private final Asset assetDown = new Asset("down_pipe.png", WIDTH, HEIGHT);
    ...
    private Sprite[] createPipes(double posX) {
        ...
        double usableHeight = screenHeight - 350;
